...
export default {
    ...
    methods: {
        ...
        loadSign(refresh) {
            let _this = this;
            Utils.ajax.post('api.php?entry=sys&c=lottery-sign&a=list&do=getList', {
                    token: _this.token,
                    page: _this.page,
                    lottery_id: _this.lottery_id,
        ...
        deleteSign(id) {
            ...
            _this.$Modal.confirm({
                ...
                content: '<p>是否删除该场景?</p>',
                onOk: () => {
                    Utils.ajax.post('api.php?entry=sys&c=lottery-sign&a=list&do=delete', {
                            token: _this.token,
                            lottery_id: _this.lottery_id,
                            id: id
                        })
