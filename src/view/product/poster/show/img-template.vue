<template>
    <div class="poster-elementWrapper dragged" v-bind:class="{ active:isActive }" v-bind:id="showId" v-bind:ctype="type" @click.stop="" :style="{
          top: cursorTop + 'px',
          left: cursorLeft + 'px',
          width: elWidth + 'px',
          height: elHeight + 'px',
        ...
        <div v-bind:style="[textJson,modifyData]" class="poster-elementWrapper_main">
            <div class="element-contents text-item">
                <div class="poster-elementItem" @click.stop="selectElement">
...
import dragSize from '@/view/product/poster/global/dragSize.vue';
//兼容禁止点击移动元素
        ...
        methods: {
            ...
            initJson() {
                ...
                if (this.elHeight === 'auto') {
                    let rect = this.$el.querySelector('.poster-elementItem_drap').getBoundingClientRect();
            ...
            handleDrag(event) {
                ...
                let width = screen.width - rect.width;
                let height = screen.height - rect.height;
